...
| **start** | skills-source/ | One-keystroke session opener: reads the temporal docs + TASKS Active, sweeps ticked tasks to Done, proposes the next move. Docs-only, never touches code | The very first prompt of a fresh session |
